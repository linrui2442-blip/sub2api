...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.APIKey, c.Account, c.AccountGroup, c.AuthIdentity, c.CompositeModelRoute,
		...
		c.UsageLog, c.User, c.UserAllowedGroup,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		APIKey, Account, AccountGroup, AuthIdentity, CompositeModelRoute,
