...
var (
	...
	AccountsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{AccountsColumns[13], AccountsColumns[14]},
			},
			{
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "image_input_tokens", Type: field.TypeInt, Default: 0},
		{Name: "request_type", Type: field.TypeInt16, Default: 0},
		...
		{Name: "service_tier", Type: field.TypeString, Nullable: true, Size: 32},
