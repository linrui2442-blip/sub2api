...
func (h *GatewayHandler) Responses(c *gin.Context) {
	...
	// 2. Re-check billing
	if err := h.eligibilityChecker().CheckBillingEligibility(requestCtx, apiKey.User, apiKey, apiKey.Group, subscription, service.QuotaPlatform(requestCtx, apiKey)); err != nil {
