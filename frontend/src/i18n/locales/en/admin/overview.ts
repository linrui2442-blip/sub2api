export default {
    ...
    users: {
      ...
      groupConfig: 'User Group Permissions',
      groupConfigHint: 'Choose which exclusive groups user {email} is allowed to access',
    ...
    groups: {
      ...
      exclusiveTooltip: {
        ...
        example: 'Use case:',
        exampleContent: 'When enabled, this group is hidden from the group choices shown to members creating API keys. Only members explicitly granted access by an administrator can use it.'
      },
